...
public class MouseClickTest : MonoBehaviour
{
    ...
    private RTSUnitControllerTest rtsUnitController;
    private KeyboardInputTest keyboardInput;
    private void Awake()
    {
        mainCamera = Camera.main;
        rtsUnitController = this.GetComponent<RTSUnitControllerTest>();
        keyboardInput = this.GetComponent<KeyboardInputTest>();
    }
